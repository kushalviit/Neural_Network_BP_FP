...
res = minimize(fun=nnCostFunction, x0=initial_theta, args=(input_layer_size, hidden_layer_size,num_labels,X,y,lamda), method='BFGS', jac=nnGradFunction,options={'maxiter': 1, 'disp': True})
